...
from Prefix_tuning.modeling_bart import NoPosBartForConditionalGeneration
from run_fine_tuning import count_parameters, set_seed, save_model
logger = logging.getLogger(__name__)


MODEL_CLASSES = {
    'gpt2': (GPT2Config, GPT2LMHeadModel, GPT2Tokenizer),
    'bart': (BartConfig, NoPosBartForConditionalGeneration, BartTokenizer),
}
